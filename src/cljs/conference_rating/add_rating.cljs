...
(def add-rating-template
  [:div {:class "row"}
   ...
   [:div {:class "col-lg-4"}
    ...
    (panel/panel "This is interesting for"
                 (form/form-block
                   (form/checkbox "Devs")
                   (form/checkbox "QAs")
                   (form/checkbox "BAs")
