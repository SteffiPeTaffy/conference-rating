...
(secretary/defroute "/" []
                    (backend/load-future-conferences 1 #(reset! conference-list/displayed-future-conferences %1))
                    (backend/load-past-conferences 1 #(reset! conference-list/displayed-past-conferences %1))
